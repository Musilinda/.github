...
|---|---|
| [web app](https://github.com/Musilinda/app_musilinda) | Full-stack web app — interactive music lessons with on-device ONNX solfège recognition. |
...
| [api](https://github.com/Musilinda/api) | Flask API - WhisperMultiHeadClassifier deep learning audio inference symbol-audio pairs. |
